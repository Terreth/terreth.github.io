	...
	$('a[href*="facebook.com/"]').each(function( index ) {
		  ...
		  console.log(textId);
		  // console.log($( this ).after('<img src="http://www.evr.gr/(../imglogo.png" textid="' + textId + '" width="18px"/>'));
		
	      if (textId.length > 4 && textId.indexOf('?') == -1  && textId.indexOf('/') == -1 )
				
				$( this ).css('color','green');
				
		  	    $( this ).after('<img src="http://www.greenz.io/img/evg-credit-1-large-shadow.png" textid="' + textId + '" width="14px"/>').next().click(
					function() {
